                    ...
                    <div className="flex justify-center align-middle">
                        <div className="relative m-5 p-2 ">
                            <div className="m-5">
                                ...
                                <input type="password" name="password" placeholder="New Password" onChange={handleChange} className="m-5 h-8 p-2 w-72 flex rounded text-black bg-white placeholder-black"/>
                                <input type="password" placeholder="Confirm Password" className="m-5 h-8 p-2 w-72 flex rounded bg-white text-black placeholder-black"/>
