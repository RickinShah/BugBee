                    ...
                    <div>
                        ...
                        <div className="p-10 w-2/3 ">
                            <p>
                                ...
                                <br/><br/>
                                BugBee is a social media platform designed to facilitate interactive discussions,
                                multimedia sharing and community engagement
                        ...
                        <div>
                            ...
                            <div className="flex justify-center ">
                                <form onSubmit={handleSubmit}>
                                    <input type="text" name='username' value={formData.username} onChange={handleChange}
                                           ...
                                           className=" p-2 m-6 h-8 w-72 flex rounded bg-white text-black placeholder-black"/>
                                    <input type="password" name='password' value={formData.password}
                                           onChange={handleChange} placeholder="Password"
                                           className=" p-2 m-6 h-8 w-72 flex rounded bg-white text-black placeholder-black"/>
                                    <button className="flex justify-center align-middle w-72 h-10 p-2 m-6 rounded-lg bg-[#1E1E1E] 
                                    hover:bg-[#564a02] font-medium" type='submit'>Sign in
                                    </button>
                                </form>
                            ...
                            <div className="flex justify-center">
                                <div>
                                    ...
                                    hover:bg-[#564a02]">Forgot Passoword?
                                        </button>
                                    </Link>
                                    <p className="flex align-middle justify-center font-medium underline">Dont have an
                                        account? <Link to="/auth/signup"
                                                       className="text-[#1E1E1E] font-bold hover:text-white ">Sign-up</Link>
                                    </p>
                                </div>
